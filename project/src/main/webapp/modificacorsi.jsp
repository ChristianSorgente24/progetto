...
<body>
	...
	<div class="row row-offcanvas row-offcanvas-left">
		...
		<div class="page-header">
			<h3><strong>Modifica del corso</strong></h3>
		</div>
		<form action="/<%= application.getServletContextName()%>/ModificaCorso" method="post"
		...
		<div class="form-group">
			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group date" id="dp1">
					...
					<input type="text" name="dataInizio" id="dataInizio" placeholder="<%= AdminFacade.getInstance().getByCodCorso((long)session.getAttribute("corso")).getDataInizioCorso()%>" class="form-control">
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group date" id="dp2">
					...
					<input type="text" name="dataFine" id="dataFine" placeholder="<%= AdminFacade.getInstance().getByCodCorso((long)session.getAttribute("corso")).getDataFineCorso()%>" class="form-control">
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group">
					...
					<input type="text" name="costo" id="costo" placeholder="<%= AdminFacade.getInstance().getByCodCorso((long)session.getAttribute("corso")).getCostoCorso()%>" class="form-control">
				</div>
			</div>
		...
		<div class="form-group">
			...
			<div class="col-md-4 inputGroupContainer">
				<div class="input-group">
					...
					<input type="text" name="aula" id="aula" placeholder="<%= AdminFacade.getInstance().getByCodCorso((long)session.getAttribute("corso")).getAulaCorso() %>" maxlength="5" class="form-control">
				</div>
			</div>
